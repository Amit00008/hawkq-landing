  ...
  return (
    <section className="relative flex min-h-screen flex-col overflow-hidden bg-background">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-1 flex-col items-center px-6 pt-6 pb-20 text-center sm:pt-10">
        ...
        {/* feed panel */}
        <div
          className="raised rise-panel mt-16 w-full max-w-5xl rounded-[18px] p-2.5 sm:mt-20"
          style={{ ["--d" as string]: "680ms" }}
        >
          <div className="overflow-hidden rounded-[12px] border border-line bg-surface-sunken">
            {/* panel bar */}
            <div className="flex items-center justify-between border-b border-line bg-surface px-4 py-2.5">
              <div className="flex items-center gap-2">
                <span className="live-dot h-1.5 w-1.5 rounded-full bg-orange-500" />
                <span className="font-mono text-[11.5px] tracking-[0.02em] text-ink-muted">
            ...
            <div className="grid items-stretch gap-px bg-line text-left lg:grid-cols-[1.05fr_1fr]">
              ...
              {/* live feed — right */}
              <div className="relative min-h-[320px] bg-[#111]">
                <video
                ...
                />
                {/* feed chrome */}
                <span className="absolute left-4 top-4 inline-flex items-center gap-1.5 rounded-[5px] bg-black/55 px-2.5 py-1.5 font-mono text-[10.5px] tracking-[0.03em] text-white/90 backdrop-blur-sm">
                  <span className="live-dot h-1.5 w-1.5 rounded-full bg-[#ef4444]" />
                  LIVE
                </span>
                <span className="absolute bottom-4 left-4 rounded-[5px] bg-black/55 px-2.5 py-1.5 font-mono text-[10.5px] tracking-[0.03em] text-white/90 backdrop-blur-sm">
                ...
                <div className="absolute left-[14%] top-[34%] h-[40%] w-[32%] rounded-[3px] border-2 border-orange-500">
                  <span className="absolute -top-[21px] left-0 whitespace-nowrap rounded-[4px] bg-orange-500 px-1.5 py-0.5 font-mono text-[10px] font-medium text-white">
                    bottleneck 0.89
                  </span>
                </div>
              </div>
